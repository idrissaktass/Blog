...
function CreateMovie ({ updateMovies }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const newMovie = { title, summary, positive, negative, username, director, duration, scale, subject };
    
    try {
      const response = await axios.post("http://localhost:3001/createMovie", newMovie);
      console.log("Movie advice created:", response.data);
      // Clear input fields
      setTitle("");
      setSummary("");
      setPositive([]);
      ...
      console.error("Error creating Movie advice:", error);
    }
  };
    ...
    <div className="form-container">
        <Form className="row form" onSubmit={handleSubmit}>
          <div className="col-sm-4 mx-3">
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Diracotr:</Form.Label>
          ...
          <Form.Group className="mb-3" controlId="formBasicPassword">
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
                ...
                <Form.Control className="form-sum" value={duration} onChange={(e) => setDuration(e.target.value)} required />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicPassword">
